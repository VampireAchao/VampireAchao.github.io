---
title: apache-tika从ppt-pdf-xls读取文本
...
[GitHub - apache/tika: The Apache Tika toolkit detects and extracts metadata and text from over a thousand different file types (such as PPT, XLS, and PDF).](https://github.com/apache/tika)
