---
title: 给项目添加chechstyle
date: 2023-04-04 22:02:50
tags: java
---

> 普通而抽象的思想是人类铸成大错的根源。——卢俊

收到个`pr`：https://gitee.com/dromara/stream-query/pulls/301

给项目添加了`checkstyle`，非常的`nice`
...
还有`LICENCE`校验`checkstyle-header.txt`：
...
之后就可以使用`mvn checkstyle:checkstyle`进行代码审查啦！