---
title: 移动端拖动滑块验证
date: 2023-01-15 22:09:43
tags: 前端
---

> 夫唯不争，故天下莫能与之争——老子

之前写过[拖动滑块验证](https://VampireAchao.github.io/2022/08/07/拖动滑块验证/)

但是发现移动端拖不动了

因为移动端使用的是`touch`事件：https://developer.mozilla.org/zh-CN/docs/Web/API/TouchEvent
...
![touchmove](/imgs/oss/blog/vampireachao/touchmove.gif)
